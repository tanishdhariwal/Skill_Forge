...
import { startInterview, genrateNextQuestion, submitInterview,resumeInterview, getAllInterviews } from "../controllers/mockInterviewController.js";
...
interviewRouter.post("/resume/:interview_id", verifyTokenUser,resumeInterview);
